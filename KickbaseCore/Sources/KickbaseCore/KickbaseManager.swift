...
public class KickbaseManager: ObservableObject {
    ...
    public func loadPlayerMarketValueHistory(playerId: String, leagueId: String) async -> MarketValueChange? {
    ...
    public func loadPlayerPerformanceWithTeamInfo(playerId: String, leagueId: String) async throws -> [EnhancedMatchPerformance]? {
    ...
    public func loadPlayerRecentPerformanceWithTeamInfo(playerId: String, leagueId: String) async -> [EnhancedMatchPerformance]? {
    ...
    public func loadPlayerUpcomingPerformanceWithTeamInfo(playerId: String, leagueId: String) async -> [EnhancedMatchPerformance]? {
