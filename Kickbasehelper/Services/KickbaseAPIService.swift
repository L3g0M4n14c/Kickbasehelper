...
class KickbaseAPIService: ObservableObject {
    ...
    func getManagerTransfers(leagueId: String, userId: String, matchDay: Int? = nil) async throws
        -> [String: Any]
    {
    ...
    func getTeamCenter(leagueId: String, userId: String, matchDay: Int? = nil) async throws
        -> [String: Any]
    {
    ...
    func getPlayerMarketValue(leagueId: String, playerId: String, timeframe: Int = 365) async throws
        -> [String: Any]
    {
        let (data, _) = try await makeRequest(
    ...
    func getPlayerTransferHistory(leagueId: String, playerId: String, matchDay: Int? = nil)
    ...
    func setPlayerTransferPrice(leagueId: String, playerId: String, price: Int) async throws
        -> [String: Any]
    {
    ...
    func withdrawOffer(leagueId: String, playerId: String, offerId: String) async throws -> [String:
        Any]
    {
        let (data, _) = try await makeRequest(
    ...
    func getActivitiesFeed(leagueId: String, start: Int? = nil, max: Int? = nil) async throws
        -> [String: Any]
    {
    ...
    func getCompetitionPlayers(competitionId: String, matchDay: Int? = nil) async throws -> [String:
        Any]
    {
    ...
    func getCompetitionPlayerPerformance(competitionId: String, playerId: String) async throws
        -> [String: Any]
    {
        let (data, _) = try await makeRequest(
    ...
    func getCompetitionPlayerMarketValue(
    ...
    func getPlayerEventHistory(competitionId: String, playerId: String, matchDay: Int? = nil)
        async throws -> [String: Any]
    {
    ...
    func getCompetitionTeamCenter(competitionId: String, teamId: String, matchDay: Int? = nil)
        async throws -> [String: Any]
    {
    ...
    func getCompetitionTeamProfile(competitionId: String, teamId: String) async throws -> [String:
        Any]
    {
        let (data, _) = try await makeRequest(
