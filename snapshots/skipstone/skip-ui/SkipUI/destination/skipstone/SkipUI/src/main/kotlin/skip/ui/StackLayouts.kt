...
internal fun rowMeasurePolicy(
    ...
    verticalAlignment: Alignment.Vertical): MeasurePolicy =
...
internal data class RowMeasurePolicy(
    ...
    private val verticalAlignment: Alignment.Vertical) : MeasurePolicy, RowColumnMeasurePolicy {
    ...
    override fun createConstraints(
        ...
        mainAxisMax: Int,
        crossAxisMax: Int,
        isPrioritizing: Boolean): Constraints {
    ...
    private fun getCrossAxisPosition(
        ...
        crossAxisLayoutSize: Int,
        beforeCrossAxisAlignmentLine: Int): Int {
        ...
        return childCrossAlignment?.align(
            ...
            placeable = placeable,
            beforeCrossAxisAlignmentLine = beforeCrossAxisAlignmentLine) ?: verticalAlignment.align(placeable.measuredHeight, crossAxisLayoutSize)
    }
...
internal fun columnMeasurePolicy(
    ...
    horizontalAlignment: Alignment.Horizontal): MeasurePolicy =
...
internal data class ColumnMeasurePolicy(
    ...
    private fun getCrossAxisPosition(
        ...
        return childCrossAlignment?.align(
            ...
            placeable = placeable,
            beforeCrossAxisAlignmentLine = beforeCrossAxisAlignmentLine) ?: horizontalAlignment.align(placeable.measuredWidth, crossAxisLayoutSize, layoutDirection)
    }
...
internal interface RowColumnMeasurePolicy {
    ...
    fun createConstraints(
        ...
        mainAxisMax: Int,
        crossAxisMax: Int,
        isPrioritizing: Boolean = false): Constraints
}
...
private constructor(private val value: Constraints) {
    ...
    constructor(
        c: Constraints,
        orientation: LayoutOrientation) : this(
    ...
    fun copy(
        ...
        crossAxisMax: Int = this.crossAxisMax): OrientationIndependentConstraints =
