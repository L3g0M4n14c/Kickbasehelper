...
///         GridRow {
///             Text("Row 1")
///             ForEach(0 until 2) { _ in Color.red }
///         }
///         GridRow {
///             Text("Row 2")
///             ForEach(0 until 5) { _ in Color.green }
///         }
///         GridRow {
///             Text("Row 3")
///             ForEach(0 until 4) { _ in Color.blue }
///         }
///     }
///
...
///         ForEach(0 until 5) { row in
///             GridRow {
///                 ForEach(0 until 5) { column in
///                     Text("(\(column), \(row))")
///                 }
///             }
///         }
...
///             ForEach(1 until 4) { column in
///                 Text("C\(column)")
///             }
///         }
///         ForEach(1 until 4) { row in
///             GridRow {
///                 Text("R\(row)")
///                 ForEach(1 until 4) { _ in
