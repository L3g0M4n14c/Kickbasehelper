...
class EnvironmentValues {
    ...
    */
    ...
    internal open val _layoutImplementationVersion: Int
        @Composable
        get() {
            return builtinValue(key = "_layoutImplementationVersion", defaultValue = { -> 1 }) as Int
        }
    internal fun set_layoutImplementationVersion(newValue: Int) {
        setBuiltinValue(key = "_layoutImplementationVersion", value = newValue, defaultValue = { -> 1 })
    }
...
///         var body: some View {
///             HStack(spacing: 1) {
///                 ForEach(0 until rating, id: \.self) { _ in
