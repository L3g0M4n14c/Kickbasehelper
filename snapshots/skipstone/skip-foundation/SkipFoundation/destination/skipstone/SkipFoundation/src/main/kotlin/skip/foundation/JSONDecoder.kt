    ...
    sealed class KeyDecodingStrategy {
        ...
        companion object {
            ...
            internal fun _convertFromSnakeCase(stringKey: String): String {
                ...
                val leadingUnderscoreRange = 0 until firstNonUnderscore_0
                val trailingUnderscoreRange = (lastNonUnderscore + 1) until stringKey.count
...
private class JSONUnkeyedDecodingContainer: UnkeyedDecodingContainerProtocol, MutableStruct {
    ...
    internal constructor(impl: JSONDecoderImpl, codingPath: Array<CodingKey>, array: Array<*>) {
        this.impl = impl
        this.codingPath = codingPath.sref()
